		...
		<td class="content-c" valign="top">
			...
			<div class="c-bottom">
				...
				<c:if test="${a.isAdopt != 1}">
					<span class="cn" style="margin-left:10px;cursor: pointer;"  data-id="${a.id }" ><i class="iconfont">&#xe605;</i><span class="xzi">采纳</span></span>
				</c:if>
				<span class="dz" style="margin-left:10px;cursor: pointer;"  data-id="${a.id }" data-types="${a.isThumbs}"><i class="iconfont">&#xe64e;</i><span class="xzi">点赞</span><span>${a.likeanswer}</span></span>
