...
<div id="modelList" class="pageRecommendtionBg">
    ...
    <div class="mainbackground nopadding bannerManage ">
        <div class="heading">
            <h2 class="h5" style="display: inline-block;margin: 10px 0;">首页通栏Banner</h2>
            <div class="bannerButton">
                ...
                <span><a href="<%=rootPath %>/Banner/addBanner/2" class="btn btn-primary " >添加banner</a></span>
            </div>
...
<script>
    ...
    function acrcoQiyong(){
        $.ajax({
            url: rootPath + "/Banner/acrcoQiyong",
            type:"post",
            data:{bannerType:2},
            dataType:"html",
            success:function(data){
