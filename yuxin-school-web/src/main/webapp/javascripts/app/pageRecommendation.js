                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (st != "") {
                                ...
                                $("#commodityLi" + id).find("i:first").text("停售").css({
                                    "background-color": "rgba(231,31,26,0.8)",
                                    "color": "white"
                                });
                                ;
        ...
        classTypeOnsale: function (id) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (st != "") {
                        //$("#commodityLi"+id).remove();
                        $("#commodityLi" + id).find("i:first").text("在售").css({
                            "background-color": "rgba(194,235,235,.8)",
                            "color": "black"
                        });
