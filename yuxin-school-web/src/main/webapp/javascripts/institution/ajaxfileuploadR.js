            ...
            if (xml || isTimeout == "timeout") {
                ...
                try {
                    ...
                    if (status != "error") {
                        ...
                        var fileEle = s.saveFlag == 0?document.getElementById('imgData'):s.saveFlag == 1?document.getElementById('imgDataVideo'):document.getElementById('imgDataStyle');
                        var imgEle = s.saveFlag == 0?document.getElementById('target'):s.saveFlag == 1?document.getElementById('targetVideo'):document.getElementById('targetStyle');
